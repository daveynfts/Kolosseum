/**
 * Merge @Thanhtalus recent followers into R2 recent-followers/v1.json.
 *
 *   node scripts/push_thanhtalus_recent_followers.mjs
 */
import fs from 'fs'
...
async function main() {
  ...
  map = { ...map, thanhtalus }
  console.log('Set map.thanhtalus =', thanhtalus.length)

  const payload = {
    version: 1,
    updatedAt: new Date().toISOString(),
    source: 'admin server · Thanhtalus recent followers curated',
    note: 'Update recent followers for @Thanhtalus (gala_nft2, hashnewshk, wjf110)',

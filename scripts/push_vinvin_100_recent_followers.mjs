/**
 * Merge @vinvin_100 (Vinh Vuong) recent followers into R2 recent-followers/v1.json.
 *
 *   node scripts/push_vinvin_100_recent_followers.mjs
 */
import fs from 'fs'
...
async function main() {
  ...
  map = { ...map, vinvin_100 }
  console.log('Set map.vinvin_100 =', vinvin_100.length)

  const payload = {
    version: 1,
    updatedAt: new Date().toISOString(),
    source: 'admin server · vinvin_100 recent followers curated',
    note: 'Update recent followers for @vinvin_100 / Vinh Vuong',

/**
 * Hide @MiaNgst01 from public map (keep full record for later promote).
 *
 *   node scripts/hide_miangst01_kol.mjs
...
async function main() {
  ...
  payload.note = unhide
    ? 'admin · re-promote @MiaNgst01 to public map'
    : 'admin · hide @MiaNgst01 from public map (kept for promote later)'
  payload.source = 'admin server · hide_miangst01_kol'

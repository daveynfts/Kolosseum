 ...
 * Implementation lives in lib/server so the JSON API does not bundle the
 * 750KB SCEX seed (that would crash the Hobby catch-all on cold start).
 */
export { publicScexDataset } from '../../lib/server/scexPublic.js'

/**
 * Merge @Gemhunter88 (Jasmine) recent followers into R2 recent-followers/v1.json.
 *
 *   node scripts/push_gemhunter88_recent_followers.mjs
 */
import fs from 'fs'
...
async function main() {
  ...
  map = { ...map, gemhunter88 }
  console.log('Set map.gemhunter88 =', gemhunter88.length)

  const payload = {
    version: 1,
    updatedAt: new Date().toISOString(),
    source: 'admin server · Gemhunter88 recent followers curated',
    note: 'Update recent followers for @Gemhunter88 / Jasmine',

/**
 * Merge @HCGemAlerts recent followers into R2 recent-followers/v1.json.
 *
 *   node scripts/push_hcgemalerts_recent_followers.mjs
 */
import fs from 'fs'
...
async function main() {
  ...
  map = { ...map, hcgemalerts }
  console.log('Set map.hcgemalerts =', hcgemalerts.length)

  const payload = {
    version: 1,
    updatedAt: new Date().toISOString(),
    source: 'admin server · HCGemAlerts recent followers curated',
    note: 'Update recent followers for @HCGemAlerts (lc_hk0x, zama)',

/**
 * Merge @LuxubuVBS recent followers into R2 recent-followers/v1.json.
 *
 *   node scripts/push_luxubuvbs_recent_followers.mjs
 */
import fs from 'fs'
...
async function main() {
  ...
  map = { ...map, luxubuvbs }
  console.log('Set map.luxubuvbs =', luxubuvbs.length)

  const payload = {
    version: 1,
    updatedAt: new Date().toISOString(),
    source: 'admin server · LuxubuVBS recent followers curated',
    note: 'Update recent followers for @LuxubuVBS (alpen, gcsbtc)',

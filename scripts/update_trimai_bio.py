#!/usr/bin/env python3
"""Write TriMaiMS bio into sheetKols + snapshot. Live display = R2 via push_kol_bio."""
...
BIO = (ROOT / "data/bio-patches/TriMaiMS.txt").read_text(encoding="utf-8").strip()
HANDLE = "TriMaiMS"
HANDLE_LC = "trimaims"
FOLLOWERS = 82300
...
def main() -> None:
    ...
    if snap_path.exists():
        ...
        for k in snap.get("kols", []):
            if str(k.get("handle", "")).lower() == HANDLE_LC:
                k["bio"] = BIO

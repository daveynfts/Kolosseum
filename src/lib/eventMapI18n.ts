...
const DICT = {
  vi: {
    ...
    calendarHide: 'Thu nhỏ lịch',
    calendarShow: 'Hiện lịch',
    calendarCollapsedHint: 'Lịch đã thu · map rộng hơn',
  ...
  en: {
    ...
    calendarHide: 'Minimize calendar',
    calendarShow: 'Show calendar',
    calendarCollapsedHint: 'Calendar hidden · larger map',
    panelTitleSimple: 'Side events',
  },
} as const

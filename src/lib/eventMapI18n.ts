...
const DICT = {
  vi: {
    ...
    pageTitleArchive: 'Conviction 2026 · Lưu trữ',
    mainHeader: 'Main · {window} · {venue} · Thủ Đức',
    mainHeaderArchive: 'Archive · Main {window} · {venue} · Thủ Đức',
    archiveBannerTitle: 'Conviction 2026 đã kết thúc',
    archiveBannerBody:
      'Đây là bản đồ lưu trữ side events (13–16/08). Pin, lịch & venue vẫn xem được — không còn đăng ký “sắp diễn ra”. Radar KOL map vẫn cập nhật trên trang chủ.',
    archiveBadge: 'Archive',
    sortChrono: 'Theo ngày',
    sortChronoTitle: 'Thứ tự lịch (ngày → giờ)',
    viewLuma: 'Xem Luma',
    liveCount: '{n} đang live',
    fromMe: 'Từ tôi',
    fromMeTitle: 'Từ vị trí của bạn',
    locating: 'Đang lấy vị trí…',
    geoDenied: 'Không lấy được vị trí. Đang đo từ Thiskyhall Sala.',
    geoUnavailable: 'Thiết bị không hỗ trợ định vị.',
    ...
    pageTitleShortArchive: 'Conviction · Archive',
  ...
  en: {
    pageTitle: 'Conviction 2026 · Side Events',
    pageTitleArchive: 'Conviction 2026 · Archive',
    mainHeader: 'Main · {window} · {venue} · Thu Duc',
    mainHeaderArchive: 'Archive · Main {window} · {venue} · Thu Duc',
    archiveBannerTitle: 'Conviction 2026 has ended',
    archiveBannerBody:
      'This is an archive map of side events (13–16 Aug). Pins, schedule & venues remain browsable — not a live registration week. KOL Radar on the home map is still updated.',
    archiveBadge: 'Archive',
    sortChrono: 'By day',
    sortChronoTitle: 'Schedule order (date → time)',
    viewLuma: 'View on Luma',
    liveCount: '{n} live now',
    fromMe: 'From me',
    fromMeTitle: 'From your location',
    locating: 'Getting your location…',
    geoDenied: 'Couldn’t get your location. Measuring from Thiskyhall Sala.',
    geoUnavailable: 'This device does not support geolocation.',
